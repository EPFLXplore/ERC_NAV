...
def generate_launch_description():
    ...
    extended       = LaunchConfiguration('extended', default = False) # keep it at False
    ...
    # point_cloud_node_orig = launch_ros.actions.ComposableNodeContainer(
    #         name='container2',
    #         namespace='',
    #         package='rclcpp_components',
    #         executable='component_container',
    ...
    #                 name='point_cloud_xyz_orig',

    #                 remappings=[('image_rect', '/stereo/converted_depth'), # used to be /stereo/converted_depth, replaced by /filtered_depth
    #                             ('camera_info', '/right/camera_info'),
    #                             ('points', '/stereo/points_orig')]
    #             ),
    #         ],
    #         output='screen',)
    ...
    #                 remappings=[('image_rect', '/filtered_depth'), # used to be /stereo/converted_depth, replaced by /filtered_depth
    #                             ('camera_info', '/right/camera_info'),
