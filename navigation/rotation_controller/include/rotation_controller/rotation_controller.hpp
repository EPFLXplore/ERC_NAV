#ifndef ROTATION_CONTROLLER__ROTATION_CONTROLLER_HPP_
#define ROTATION_CONTROLLER__ROTATION_CONTROLLER_HPP_
...
/**
 * @class rotation_controller::RotationController
 * @brief Rotate to rough path heading controller plugin
 */
class RotationController : public nav2_core::Controller
{
public:
  /**
   * @brief Constructor for rotation_controller::RotationController
   */
  RotationController();

  /**
   * @brief Destrructor for rotation_controller::RotationController
   */
...
protected:
  ...
  rclcpp::Logger logger_ {rclcpp::get_logger("RotationController")};
  ...
  double initial_rotation_goal_yaw_;
...
#endif  // ROTATION_CONTROLLER__ROTATION_CONTROLLER_HPP_